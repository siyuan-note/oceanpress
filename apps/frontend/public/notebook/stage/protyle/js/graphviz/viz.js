...
(function (global, factory) {
    ...
    return new Promise(function (resolve, reject) {
      fabric.loadSVGFromString(svgXml, function (objects, options) {
        ...
        image.src = canvas.toDataURL(
          {format: format, multiplier: multiplier, quality: quality})
  ...
  var Viz = function () {
    function Viz () {
      ...
      } else if (typeof Module !== 'undefined' && typeof render !==
        'undefined') {
        this.wrapper = new ModuleWrapper(Module, render)
      } else if (typeof Viz.Module !== 'undefined' && typeof Viz.render !==
        'undefined') {
    ...
    createClass(Viz, [
      {
          ...
          for (var i = 0; i < images.length; i++) {
            files.push({
              ...
              data: '<?xml version="1.0" encoding="UTF-8" standalone="no"?>\n<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">\n<svg width="' +
                images[i].width + '" height="' + images[i].height + '"></svg>',
            })
          }
        ...
        value: function renderSVGElement (src) {
          ...
          return this.renderString(src, _extends({}, options, {format: 'svg'})).
            then(function (str) {
        ...
        value: function renderImageElement (src) {
          ...
          return this.renderString(src, _extends({}, options, {format: 'svg'})).
            then(function (str) {
              if ((typeof fabric === 'undefined' ? 'undefined' : _typeof(
                fabric)) === 'object' && fabric.loadSVGFromString) {
                return svgXmlToImageElementFabric(str,
                  {scale: scale, mimeType: mimeType, quality: quality})
              } else {
        ...
        value: function renderJSONObject (src) {
          ...
          return this.renderString(src,
            _extends({}, options, {format: format})).then(function (str) {
